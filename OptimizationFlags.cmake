...
if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    set(CMAKE_CXX_FLAGS_RELEASE "${ARCHI_FLAG} ${OPTIM_DEBUG_FLAG} ${OPTIM_LEVEL_FLAG} ${OPTIM_MEM_FLAG} ${OPTIM_FAST_MATH_FLAG}" CACHE STRING "" FORCE)
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
    set(CMAKE_CXX_FLAGS_RELEASE "${ARCHI_FLAG} ${OPTIM_DEBUG_FLAG} ${OPTIM_LEVEL_FLAG} ${OPTIM_MEM_FLAG} ${OPTIM_FAST_MATH_FLAG}" CACHE STRING "" FORCE)
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
    set(CMAKE_CXX_FLAGS_RELEASE "${ARCHI_FLAG} -fast ${OPTIM_DEBUG_FLAG} ${OPTIM_LEVEL_FLAG} ${OPTIM_MEM_FLAG} ${OPTIM_FAST_MATH_FLAG}" CACHE STRING "" FORCE)
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    message(FATAL "MSVC not supported")
endif()
...
function(create_cuda_target)
    ...
    target_include_directories(${PREFIX_NAME} PRIVATE ${PREFIX_PRIVATE_INCLUDE_DIRECTORIES})
    target_link_libraries(${PREFIX_NAME} ${PREFIX_DEPENDENCIES})
    target_link_libraries(${PREFIX_NAME} PRIVATE -lcudart)
    target_link_libraries(${PREFIX_NAME} PRIVATE -lcublas)
    target_link_libraries(${PREFIX_NAME} PRIVATE -lcusolver)
    target_link_libraries(${PREFIX_NAME} PRIVATE -lcusparse)
